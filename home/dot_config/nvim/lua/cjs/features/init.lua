-- copied from https://github.com/mattr-/dotfiles/blob/main/home/dot_config/nvim/lua/mattr-/features/init.lua
...
local path = Path:new({ vim.fn.stdpath("config"), "lua", "cjs", "features", "tools" })
